...
#   java -Doracle.jdbc.Trace=true -Djava.util.logging.config.file=../src/log.properties -Dstart.property=../src/CUWCD_data.property dataloader.ProcessUSACEfile CUWCD_data.2019110320
