...
sqlplus 'DBA/PASSWD as sysdba' @./PERMISSIONS/create_app_user.sql $HDB_LOCAL > create_app_user.out;
sqlplus 'DBA/PASSWD as sysdba' < ./PERMISSIONS/local_user.sql > local_user.out
