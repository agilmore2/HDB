...
sqlplus sys/hdb2 @./PERMISSIONS/create_psswd_user.sql $HDB_LOCAL > create_psswd_user.out;
sqlplus sys/hdb2 < ./PERMISSIONS/set_role_passwords.sql > set_role_passwords.out;
...
sqlplus sys/hdb2 @./PERMISSIONS/create_app_user.sql $HDB_LOCAL > create_app_user.out;
sqlplus sys/hdb2 < ./PERMISSIONS/local_user.sql > local_user.out
