...
sqlplus 'uchdba/uchdbdev as sysdba' @./PERMISSIONS/create_psswd_user.sql $HDB_LOCAL > create_psswd_user.out;
sqlplus 'uchdba/uchdbdev as sysdba' ./PERMISSIONS/set_role_passwords.sql > set_role_passwords.out;
...
sqlplus 'uchdba/uchdbdev as sysdba' @./PERMISSIONS/create_app_user.sql $HDB_LOCAL > create_app_user.out;
sqlplus 'uchdba/uchdbdev as sysdba' < ./PERMISSIONS/local_user.sql > local_user.out
