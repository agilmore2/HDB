...
--Public synonyms
CREATE OR REPLACE PUBLIC SYNONYM HDB_SITE_ARCHIVE FOR UCHDBA.HDB_SITE_ARCHIVE;
CREATE OR REPLACE PUBLIC SYNONYM HDB_DATATYPE_ARCHIVE FOR UCHDBA.HDB_DATATYPE_ARCHIVE;
CREATE OR REPLACE PUBLIC SYNONYM HDB_SITE_DATATYPE_ARCHIVE FOR UCHDBA.HDB_SITE_DATATYPE_ARCHIVE;
/

--Grants to ROLES
GRANT READ ON  HDB_SITE_ARCHIVE to HDB_READ_ROLE;
GRANT READ ON  HDB_DATATYPE_ARCHIVE to HDB_READ_ROLE;
GRANT READ ON  HDB_SITE_DATATYPE_ARCHIVE to HDB_READ_ROLE;
GRANT SELECT ON  HDB_SITE_ARCHIVE to HDB_WRITE_ROLE;
GRANT SELECT ON  HDB_DATATYPE_ARCHIVE to HDB_WRITE_ROLE;
GRANT SELECT ON  HDB_SITE_DATATYPE_ARCHIVE to HDB_WRITE_ROLE;
GRANT SELECT ON  HDB_SITE_ARCHIVE to HDB_META_ROLE;
GRANT SELECT ON  HDB_DATATYPE_ARCHIVE to HDB_META_ROLE;
GRANT SELECT ON  HDB_SITE_DATATYPE_ARCHIVE to HDB_META_ROLE;
/
