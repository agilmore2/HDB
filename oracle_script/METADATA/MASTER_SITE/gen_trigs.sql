...
REM hdb_datatype removedby M. Bogner, Sutron Corp 23-June 2011  since that trigger has been customized for DECODE.datatype table
...
set feedback on
@gen_trigs_script;
@snap_czar_modified_triggers.trg;
