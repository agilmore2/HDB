...
static unsigned long sqlctx = 148371;
...
and b.unit_id=:b3)";
       ...
       sqlstm.sqhstv[0] = (         void  *)&unit_id_value;
       ...
       sqlstm.sqhstv[2] = (         void  *)&sqlUnitId;
...
_id=b.datatype_id) and b.unit_id=c.unit_id)";
            ...
            sqlstm.sqlety = (unsigned short)256;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)proper_units_string;
...
atatype_id=b.datatype_id) and b.unit_id=c.unit_id)";
    ...
    sqlstm.sqlety = (unsigned short)256;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (         void  *)units_string;
    sqlstm.sqhstl[0] = (unsigned int  )33;
    sqlstm.sqhsts[0] = (         int  )0;
    sqlstm.sqindv[0] = (         void  *)0;
    sqlstm.sqinds[0] = (         int  )0;
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (         void  *)&unit_id_value;
    sqlstm.sqhstl[1] = (unsigned int  )sizeof(int);
    sqlstm.sqhsts[1] = (         int  )0;
    sqlstm.sqindv[1] = (         void  *)0;
    sqlstm.sqinds[1] = (         int  )0;
