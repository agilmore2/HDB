...
static unsigned int sqlctx = 85207715;
...
{12,4130,1,0,0,
5,0,0,1,65,0,1029,48,0,0,1,1,0,0,128,1,3,0,0,1,97,0,0,
};
...

{
  ...
  sqlstm.stmt = "update REF_MODEL_RUN  set SYS_DATE=SYSDATE where MODEL_RUN_\
ID=:b1";
  ...
  sqlstm.sqhstv[0] = (unsigned char  *)&the_model_run_id;
