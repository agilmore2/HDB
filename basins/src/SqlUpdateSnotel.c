...
static unsigned int sqlctx = 21299851;
...
{12,4130,1,0,0,
5,0,0,1,106,0,4,78,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
28,0,0,2,103,0,4,79,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
51,0,0,3,229,0,6,125,0,0,10,10,0,1,0,1,3,0,0,1,5,0,0,3,5,0,0,1,4,0,0,1,3,0,0,1,
9,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
106,0,0,4,0,0,31,142,0,0,0,0,0,1,0,
121,0,0,5,0,0,29,146,0,0,0,0,0,1,0,
136,0,0,6,106,0,4,193,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
159,0,0,7,103,0,4,194,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
182,0,0,8,231,0,6,244,0,0,10,10,0,1,0,1,3,0,0,1,5,0,0,3,5,0,0,1,4,0,0,1,3,0,0,
1,9,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
237,0,0,9,0,0,31,262,0,0,0,0,0,1,0,
252,0,0,10,0,0,29,266,0,0,0,0,0,1,0,
267,0,0,11,106,0,4,309,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
290,0,0,12,103,0,4,310,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
313,0,0,13,229,0,6,358,0,0,10,10,0,1,0,1,3,0,0,1,5,0,0,3,5,0,0,1,4,0,0,1,3,0,0,
1,9,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
368,0,0,14,0,0,31,375,0,0,0,0,0,1,0,
383,0,0,15,0,0,29,379,0,0,0,0,0,1,0,
398,0,0,16,106,0,4,420,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
421,0,0,17,103,0,4,421,0,0,2,1,0,1,0,1,5,0,0,2,5,0,0,
444,0,0,18,231,0,6,470,0,0,10,10,0,1,0,1,3,0,0,1,5,0,0,3,5,0,0,1,4,0,0,1,3,0,0,
1,9,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
499,0,0,19,0,0,31,487,0,0,0,0,0,1,0,
514,0,0,20,0,0,29,493,0,0,0,0,0,1,0,
};
...
,'dd-mon-yyyy hh24:mi:ss') into :b1  from dual ";
  ...
  sqlstm.sqhstv[1] = (unsigned char  *)start_date_time;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select TO_CHAR((TO_DATE(:b0,'dd-mon-yyyy hh24:mi:ss')+1),'d\
d-mon-yyyy hh24:mi:ss') into :b1  from dual ";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (unsigned char  *)start_date_time;
  sqlstm.sqhstl[0] = (unsigned long )21;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         short *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (unsigned char  *)end_date_time;
  sqlstm.sqhstl[1] = (unsigned long )21;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         short *)0;
  sqlstm.sqinds[1] = (         int  )0;
...
t_date_time , :end_date_time , :curSnow , :agen_id , NULL , :validationFlag , \
:collection_system_id , :loading_application_id , :method_id , :computation_id\
 , 'Y' ) ; END ;";
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (unsigned char  *)end_date_time;
    ...
    sqlstm.sqhstv[3] = (unsigned char  *)&curSnow;
    ...
    sqlstm.sqhstv[4] = (unsigned char  *)&agen_id;
    ...
    sqlstm.sqhstv[5] = (unsigned char  *)&validationFlag;
    ...
    sqlstm.sqhstv[6] = (unsigned char  *)&collection_system_id;
    ...
    sqlstm.sqhstv[7] = (unsigned char  *)&loading_application_id;
    ...
    sqlstm.sqhstv[8] = (unsigned char  *)&method_id;
    ...
    sqlstm.sqhstv[9] = (unsigned char  *)&computation_id;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "begin modify_r_base_raw ( :siteDatatypeId , 'day' , :start\
_date_time , :end_date_time , :curPrecip , :agen_id , NULL , :validationFlag ,\
 :collection_system_id , :loading_application_id , :method_id , :computation_i\
d , 'Y' ) ; END ;";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (unsigned char  *)&curPrecip;
   sqlstm.sqhstl[3] = (unsigned long )sizeof(float);
   sqlstm.sqhsts[3] = (         int  )0;
   sqlstm.sqindv[3] = (         short *)0;
   sqlstm.sqinds[3] = (         int  )0;
...

{
   ...
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "begin modify_r_base_raw ( :siteDatatypeId , 'day' , :start\
_date_time , :end_date_time , :pctSnow , :agen_id , NULL , :validationFlag , :\
collection_system_id , :loading_application_id , :method_id , :computation_id \
, 'Y' ) ; END ;";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (unsigned char  *)&pctSnow;
   sqlstm.sqhstl[3] = (unsigned long )sizeof(float);
   sqlstm.sqhsts[3] = (         int  )0;
   sqlstm.sqindv[3] = (         short *)0;
   sqlstm.sqinds[3] = (         int  )0;
...
id , 'Y' ) ; END ;";
    ...
    sqlstm.sqadto[2] = (unsigned short )0;
    sqlstm.sqtdso[2] = (unsigned short )0;
    sqlstm.sqhstv[3] = (unsigned char  *)&pctPrecip;
    sqlstm.sqhstl[3] = (unsigned long )sizeof(float);
    sqlstm.sqhsts[3] = (         int  )0;
    sqlstm.sqindv[3] = (         short *)0;
    sqlstm.sqinds[3] = (         int  )0;
