...
static unsigned long sqlctx = 1307811;
...
{10,4130,0,0,0,
5,0,0,1,58,0,1028,56,0,0,2,1,0,0,128,2,3,0,0,1,97,0,0,1,97,0,0,
32,0,0,2,0,0,1053,70,0,0,0,0,0,0,128,1,97,0,0,
51,0,0,3,103,0,1028,109,0,0,2,1,0,0,128,2,3,0,0,1,97,0,0,1,97,0,0,
78,0,0,4,0,0,1053,123,0,0,0,0,0,0,128,1,97,0,0,
97,0,0,5,97,0,1028,162,0,0,2,1,0,0,128,2,3,0,0,1,97,0,0,1,97,0,0,
124,0,0,6,0,0,1053,176,0,0,0,0,0,0,128,1,97,0,0,
143,0,0,7,64,0,1028,215,0,0,2,1,0,0,128,2,3,0,0,1,97,0,0,1,97,0,0,
170,0,0,8,0,0,1053,229,0,0,0,0,0,0,128,1,97,0,0,
189,0,0,9,85,0,1028,268,0,0,2,1,0,0,128,2,3,0,0,1,97,0,0,1,97,0,0,
216,0,0,10,0,0,1053,282,0,0,0,0,0,0,128,1,97,0,0,
235,0,0,11,85,0,1028,321,0,0,2,1,0,0,128,2,97,0,0,1,97,0,0,1,97,0,0,
262,0,0,12,0,0,1053,335,0,0,0,0,0,0,128,1,97,0,0,
};
...

{
   ...
   sqlstm.stmt = "select agen_id into :b1  from hdb_agen where agen_name=:b2";
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select loading_application_id into :b1  from hdb_loading_a\
pplication where loading_application_name=:b2";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select collection_system_id into :b1  from hdb_collection_\
system where collection_system_name=:b2";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select method_id into :b1  from hdb_method where method_na\
me=:b2";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select computation_id into :b1  from hdb_computed_datatype\
 where computation_name=:b2";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select overwrite_flag into :b1  from hdb_overwrite_flag wh\
ere overwrite_flag_name=:b2";
   sqlstm.iters = (unsigned int  )1;
