...
static unsigned long sqlctx = 41967179;
...
{10,4130,0,0,0,
5,0,0,1,68,0,1028,49,0,0,2,1,0,0,128,2,3,0,0,1,3,0,0,1,97,0,0,
};
...

{
    ...
    sqlstm.stmt = "select count(*)  into :b1  from ref_model_run where model\
_run_id=:b2";
    ...
    sqlstm.sqhstv[0] = (         void  *)&the_count;
